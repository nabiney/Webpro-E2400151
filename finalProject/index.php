  ...
  <body>
        ...
        <!-- <div class="width-100 banner-section">
            ...
            <div class="search-sect">
                <input type="text" class="search-textbox" placeholder="Enter Job Title">
            </div>
            <div class="search-sect">
                <input type="text" class="search-textbox" placeholder="Enter Company Name">
                <i class="fa fa-life-ring icons" aria-hidden="true"></i>
            </div>

            <div class="search-sect">
                <input type="text" class="search-textbox" placeholder="Enter Location">
                <i class="fa fa-life-ring icons" aria-hidden="true"></i>
            </div>            
            <div class="search-sect">
        ...
        <div class="width-100 recent-job">
            ...
            <div class="width-50">
                ...
                <div class="width-100">
                    ...
                    <p class="job-company">Leapfrog <i class="fa fa-star" aria-hidden="true"></i> | 234 Reviews </p>
                </div>
                <div class="width-33">
                    <i class="fa fa-briefcase" aria-hidden="true"></i> 1 to 4 Years
                </div>
                <div class="width-33">
                    <i class="fa fa-inr" aria-hidden="true"></i> Negotiable
                </div>
                <div class="width-33">
                    <i class="fa fa-map-marker" aria-hidden="true"></i> Kathmandu
                </div>
                <div class="width-100">
                    <p class="job-skill">
                ...
                <div class="width-100">
                    <a href="apply.html" class="job-apply-button">Apply Now</a>
                </div>

                </div>
            </div>

            <div class="width-50" id="recent-jobs">
                <div class="recent-job-list">
                <div class="width-100">
                    <h4 class="job-title">Backend Designer</h4>
                    <p class="job-company">Fusemachines Nepal Pvt Ltd <i class="fa fa-star" aria-hidden="true"></i> | 234 Reviews </p>
                </div>
                <div class="width-33">
                    <i class="fa fa-briefcase" aria-hidden="true"></i> 1 to 4 Years
                </div>
            ...
            <div class="width-50">
                ...
                <div class="width-100">
                    ...
                    <p class="job-company">Deerwalk <i class="fa fa-star" aria-hidden="true"></i> | 234 Reviews </p>
                </div>
                <div class="width-33">
                    <i class="fa fa-briefcase" aria-hidden="true"></i> 1 to 4 Years
                </div>
            ...
            <div class="width-50">
                ...
                <div class="width-100">
                    ...
                    <p class="job-company">F1Soft International <i class="fa fa-star" aria-hidden="true"></i> | 234 Reviews </p>
                </div>
                <div class="width-33">
                    <i class="fa fa-briefcase" aria-hidden="true"></i> 1 to 4 Years
                </div>
            ...
            <div class="width-50">
                ...
                <div class="width-100">
                    ...
                    <p class="job-company">YoungInnovations <i class="fa fa-star" aria-hidden="true"></i> | 234 Reviews </p>
                </div>
                <div class="width-33">
                    <i class="fa fa-briefcase" aria-hidden="true"></i> 1 to 4 Years
                </div>
                ...
                <div class="width-33">
                    <i class="fa fa-map-marker" aria-hidden="true"></i> Pokhara
                </div>
                <div class="width-100">
                    <p class="job-skill">
                    <b>Skills : </b>Photoshop or Quark Xpress
                    </p>
                </div>
                <div class="width-100">
                    <a href="apply.html" class="job-apply-button">Apply Now</a>
            ...
            <div class="width-50">
                ...
                <div class="width-100">
                    ...
                    <p class="job-company">Braindigit IT Solution <i class="fa fa-star" aria-hidden="true"></i> | 234 Reviews </p>
                </div>
                <div class="width-33">
                    <i class="fa fa-briefcase" aria-hidden="true"></i> 1 to 4 Years
                </div>
                ...
                <div class="width-100">
                    <p class="job-skill">
                    <b>Skills : </b>Familiar with various JavaScript frameworks
                    </p>
                </div>
                <div class="width-100">
                    <a href="apply.html" class="job-apply-button">Apply Now</a>
